...
describe('tests of practice 01', function () {
    ...
    it("given Student with age 21, name Tom and class 2, get introduce", function () {
        ...
        var cls = new Class(2);
        var student = new Student(21, "Tom", cls);
    ...
    it("given Teacher with age 25, name Bob and teaches class 2, get introduce", function () {
        ...
        var cls = new Class(2);
        var teacher = new Teacher(25, "Bob", cls);
    ...
    it("given Teacher with age 25, name Bob and teaches no class, get introduce", function () {
        ...
        var teacher = new Teacher(25, "Bob", new Class());
        var intro = teacher.introduce();

        expect(intro).toBe("My name is Bob. I am 25 years old. I am a Teacher. I teach No Class.");
    });

    it("given Teacher and Student with the same class, get introduceWith", function () {
        ...
        expect(intro).toBe("My name is Bob. I am 25 years old. I am a Teacher. I teach Tom.");
    });

    it("given Teacher and Student with the different class, get introduceWith", function () {

        var tcls = new Class(2);
        var scls = new Class(3);
        var teacher = new Teacher(25, "Bob", tcls);
        var student = new Student(21, "Tom", scls);
        var intro = teacher.introduceWith(student);

        expect(intro).toBe("My name is Bob. I am 25 years old. I am a Teacher. I don't teach Tom.");
    });
